...
class App extends Component {
  render() {
    return (
      <BrowserRouter basename="/EveryInteract">
        <div className="App">
          <Header />
          <StatsBar>
            <div className="container">
              <div className="row middle-lg">
                <div className="col-lg-offset-3 col-lg-6 start-lg">
                  ...
                  <StatsItem to="/following">
                    <StatsName>Following</StatsName>
                    <StatsValue>8,058</StatsValue>
                  </StatsItem>
                  <StatsItem to="/followers">
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg-6 start-lg">
                <TweetNavMenu>
                  <TweetNavLink to="/"> Tweets </TweetNavLink>
                  <TweetNavLink to="with_replies">Tweets&Replies</TweetNavLink>
                  <TweetNavLink to="media">Media</TweetNavLink>
                </TweetNavMenu>
                <TweetList>
